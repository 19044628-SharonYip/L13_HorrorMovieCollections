...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_PGRATE = "pgRate";
    ...
    public long insertMovie(String name, int year, String description, int pgRate, int stars) {
        ...
        values.put(COLUMN_PGRATE, pgRate);
    ...
    public ArrayList<Movie> getAllMovie() {
        ...
        String selectQuery = "SELECT " + COLUMN_ID + ","
                + COLUMN_NAME + "," + COLUMN_YEAR + "," + COLUMN_DESCRIPTION + ","
                + COLUMN_PGRATE + ","
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                int pgRate = cursor.getInt(4);
                int stars = cursor.getInt(5);

                Movie newMovie = new Movie(id, name, year, desc, pgRate, stars);
    ...
    public ArrayList<Movie> getAllMovieByStars(int starsFilter) {
        ArrayList<Movie> movieslist = new ArrayList<Movie>();

        SQLiteDatabase db = this.getReadableDatabase();
        String[] columns= {COLUMN_ID, COLUMN_NAME, COLUMN_YEAR, COLUMN_DESCRIPTION, COLUMN_PGRATE, COLUMN_STARS};
    ...
    public int updateMovie(Movie data){
        ...
        values.put(COLUMN_PGRATE, data.getPgRate());
